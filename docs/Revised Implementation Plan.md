...
Reference note: This document is retained as an early implementation sketch. Use [Game Vision.md](Game%20Vision.md) as the canonical source of truth for current product direction, gameplay goals, and final-form architecture.
